  ...
  render() {
    return html`
      <div class="header">
        ...
        <difficulty-selector .isDisabled="${this.gameStarted}" @difficulty-changed="${this.changeDifficulty}">
        </difficulty-selector>
      </div>
      ...
      ${this.showModal
        ? html` <end-modal .score="${this.score}" @restart-game="${this.restarGame}"> </end-modal> `
        : ""}
    `;
  }
}
