  ...
  render() {
    return html`
      ...
      <div class="home-container">
        ...
        <input type="text" @input="${this.handleInput}" .value="${this.username}" placeholder="Nombre del jugador" />
        <button id="login-button" @click="${this.handleLogin}" ?disabled="${!this.username.trim()}">
          Entrar al Juego
        </button>
      </div>
    `;
